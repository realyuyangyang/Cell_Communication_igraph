...
merged <- read_excel("C:/xyq/Alveolar_regeneration/data/Table_S6_(Receptor_ligand_pairs).xlsx",
                     sheet = 1)
...
E(Graph)$arrow.size=0.05 #设置箭头大小
#生成图
plot(Graph, 
     layout=layout_style,
     vertex.color="springgreen",
     remove.loops=F, 
     edge.color="firebrick2")
